...
| CAD | Parameter batches, sketches and constraints, selected solid features, occurrence placement, rigid as-built joints, configurations and materials | Exact operation variants are discoverable; no automatic conversion to direct mode or arbitrary API reflection |
